...
![Warm throughput metrics vs archive size](docs/bench-throughput-overview.svg)

- Small knowledge base: 70,247 docs/s, 1,134.2 queries/s, 2.85 ms JSON batch, 174.2 MB/s throughput
- Enterprise archive: 37,808 docs/s, 203.4 queries/s, 26.45 ms JSON batch, 84.8 MB/s throughput
...
2. Run `pnpm run bench` locally to refresh `LOCAL_BENCHMARK.md` with your machine stats (git ignored).
3. Use Git history for `BENCHMARK.md` (updated by CI) before claiming regressions or improvements.
